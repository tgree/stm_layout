...
if __name__ == '__main__':
    ...
    parser.add_argument('--pin-db', '-p', default='pinout_750.db')
    parser.add_argument('--chip', '-c', choices=['lqfp100', 'ufbga176+25',
                                                 'tfbga240+25'],
                        default='ufbga176+25')
    ...
    if rv.chip == 'lqfp100':
        chip = db.lqfp_chip
    elif rv.chip == 'ufbga176+25':
        chip = db.ufbga_chip
    elif rv.chip == 'tfbga240+25':
        chip = db.tfbga_chip
